...
if __name__ == "__main__":
    num_keys = 10000
    keys = [random.randint(1, 100000) for _ in range(num_keys)]
    ...
    time_array = [insertion_time / num_keys for _ in range(num_keys)]

    plt.plot(elems, time_array)
    plt.xlabel("Number of elements")
    plt.ylabel("Average insertion time per element")
    plt.title("Time complexity of insertion in a red-black tree")
    plt.show()